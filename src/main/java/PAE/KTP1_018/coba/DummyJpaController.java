 ...
 */
package PAE.KTP1_018.coba;

import PAE.KTP1_018.coba.exceptions.NonexistentEntityException;
import PAE.KTP1_018.coba.exceptions.PreexistingEntityException;
...
public class DummyJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("PAE_KTP1_018_jar_0.0.1-SNAPSHOTPU");
